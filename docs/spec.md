...
| Electoral votes  | 2026 Factored Revenue (used in revenue accumulation only) |
...
| 2026 Factored Revenue | TCV × PWIN (used for FY26 revenue accumulation)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Salesforce export |
...
**Clarification:** TCV does not directly control visual thickness or area. FY26 factored revenue drives cumulative revenue calculations and terminal success.
